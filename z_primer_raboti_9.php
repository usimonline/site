...
<head>
	...
	<title>Пример готовой дипломной работы по уголовному праву учету от рефератной компании "<?php echo $site_name;?>"</title>
	...
	Типичный пример по уголовному праву позволит вам оценить квалификацию наших мастеров пера, заказывайте работы у нас!">
	<meta name="keywords" content="Пример готовой дипломной работы по уголовному праву">
...
<div style="background: url(/img/leather1.jpg) repeat-x left top; padding-top: 40px;">
	<section class="main">
		...
		<div>
			<!-- section of script -->
			<h1>Пример готовой дипломной работы по уголовному праву от рефератной компании "<?php echo $site_name;?>"</h1>
			<?php
