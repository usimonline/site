...
<head>
	...
	<title>Пример готовой дипломной работы по государственному управлению от рефератной компании "<?php echo $site_name;?>"</title>
	...
	Типичный пример по государственному управлению позволит вам оценить квалификацию наших мастеров пера, заказывайте работы у нас!">
	<meta name="keywords" content="Пример готовой дипломной работы по государственному управлению">
...
<div style="background: url(/img/leather1.jpg) repeat-x left top; padding-top: 40px;">
	<section class="main">
		...
		<div>
			<!-- section of script -->
			<h1>Пример готовой дипломной работы по государственному управлению от рефератной компании "<?php echo $site_name;?>"</h1>
			<?php
			...
			?>
			<br><a href="z_primer_raboti_1.php">Смотреть первый пример дипломной работы</a>
		</div>
